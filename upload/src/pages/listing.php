...
$pageTitle = htmlspecialchars($item['title']) . ' - AvrupaPazari';
...
<head>
    ...
    <style>*{margin:0;padding:0;box-sizing:border-box}body{font-family:'Inter',-apple-system,sans-serif;background:#f5f6f8;color:#1a1a2e;line-height:1.5}</style>
    <link rel="stylesheet" href="<?= BASE_URL ?>/assets/css/listing.css?v=2">
</head>
<body>
...
function toggleFav() {
    ...
    .then(function(r){return r.json();}).then(function(data){
        ...
        if(data.status==='login_required'){window.location='login.php?redirect='+encodeURIComponent(window.location.href);return;}
