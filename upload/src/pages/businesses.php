                    ...
                    <div class="sh-grid" id="businessesGrid">
                        ...
                        ?>
                            <article class="sh-card business-card">
                                <a href="<?= e(BASE_URL) ?>/esnaf.php?slug=<?= e($slug) ?>" class="sh-card-media business-media">
                                ...
                                <div class="sh-card-body">
                                    ...
                                    <h3 class="sh-card-title">
                                        <a href="<?= e(BASE_URL) ?>/esnaf.php?slug=<?= e($slug) ?>"><?= e($name) ?></a>
                                    </h3>
                                    ...
                                    <div class="sh-card-footer">
                                        ...
                                        <a class="business-profile-link" href="<?= e(BASE_URL) ?>/esnaf.php?slug=<?= e($slug) ?>">
