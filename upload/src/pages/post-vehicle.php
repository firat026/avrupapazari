...
$t = [
    'tr' => [
        'page_title' => 'Araç İlanı Ver',
        'vehicle_info' => 'Araç Bilgileri',
        'listing_info' => 'İlan Bilgileri',
        'title' => 'İlan Başlığı',
        'title_placeholder' => 'Örn: 2019 Volkswagen Golf 1.5 TSI',
        'description' => 'Açıklama',
        'desc_placeholder' => 'Aracınız hakkında detaylı bilgi verin...',
        'price' => 'Fiyat (€)',
        ...
        'features' => 'Özellikler',
        'features_options' => 'Opsiyon / Donanım',
        'features_maintenance' => 'Bakım',
        'features_tax' => 'Vergi',
        'images' => 'Fotoğraflar',
        'images_desc' => 'En fazla 10 fotoğraf yükleyebilirsiniz. İlk fotoğraf kapak resmi olacaktır.',
        ...
        'automaat' => 'Otomatik',
        'rdw_source' => 'RDW\'den alındı',
        'from_modal' => 'Önceki adımdan aktarıldı',
        'no_data' => 'Araç verisi bulunamadı. Lütfen ilan ver butonundan başlayın.',
        'dealer_maintained' => 'Yetkili servis bakımlı',
        'maintenance_book' => 'Bakım defteri mevcut',
        'btw_deductible' => 'KDV düşülebilir',
        'existing_images' => 'Önceden yüklenen fotoğraflar',
    ],
    'nl' => [
        'page_title' => 'Voertuig Advertentie Plaatsen',
        'vehicle_info' => 'Voertuiggegevens',
        'listing_info' => 'Advertentiegegevens',
        'title' => 'Titel',
        'title_placeholder' => 'Bijv: 2019 Volkswagen Golf 1.5 TSI',
        'description' => 'Beschrijving',
        'desc_placeholder' => 'Geef een gedetailleerde beschrijving van uw voertuig...',
        'price' => 'Prijs (€)',
        'price_type' => 'Prijstype',
        'fixed' => 'Vaste Prijs',
        'negotiable' => 'Vraagprijs',
        'exchange' => 'Ruilen',
        'free' => 'Gratis',
        ...
        'features' => 'Opties & Accessoires',
        'features_options' => 'Opties',
        'features_maintenance' => 'Onderhoud',
        'features_tax' => 'BTW',
        'images' => 'Foto\'s',
        'images_desc' => 'U kunt maximaal 10 foto\'s uploaden. De eerste foto wordt de omslagfoto.',
        'drag_drop' => 'Sleep of klik om te uploaden',
        'formats' => 'JPG, PNG, WebP (max 5MB)',
        'submit' => 'Voorbeeld bekijken',
        'required' => 'Dit veld is verplicht',
        'handgeschakeld' => 'Handgeschakeld',
        'automaat' => 'Automaat',
        'rdw_source' => 'Via RDW ingevuld',
        'from_modal' => 'Overgenomen uit vorige stap',
        'no_data' => 'Geen voertuiggegevens gevonden. Begin opnieuw via de advertentieknop.',
        'dealer_maintained' => 'Dealer onderhouden',
        'maintenance_book' => 'Onderhoudsboekje',
        'btw_deductible' => 'BTW verrekenbaar',
        'existing_images' => 'Eerder geüploade foto\'s',
    ],
    'en' => [
        'page_title' => 'Post Vehicle Listing',
        'vehicle_info' => 'Vehicle Information',
        'listing_info' => 'Listing Details',
        'title' => 'Title',
        'title_placeholder' => 'E.g: 2019 Volkswagen Golf 1.5 TSI',
        'description' => 'Description',
        'desc_placeholder' => 'Provide detailed information about your vehicle...',
        'price' => 'Price (€)',
        ...
        'features_maintenance' => 'Maintenance',
        'features_tax' => 'Tax',
        'images' => 'Photos',
        'images_desc' => 'You can upload up to 10 photos. The first photo will be the cover image.',
        'drag_drop' => 'Drag & drop or click to upload',
        'formats' => 'JPG, PNG, WebP (max 5MB)',
        'submit' => 'Preview Listing',
        'required' => 'This field is required',
        'handgeschakeld' => 'Manual',
        'automaat' => 'Automatic',
        'rdw_source' => 'Filled from RDW',
        'from_modal' => 'Carried over from previous step',
        'no_data' => 'No vehicle data found. Please start from the post listing button.',
        'dealer_maintained' => 'Dealer maintained',
        'maintenance_book' => 'Service book available',
        'btw_deductible' => 'VAT deductible',
        'existing_images' => 'Previously uploaded photos',
    ],
];
...
<link rel="stylesheet" href="<?= BASE_URL ?>/assets/css/post-vehicle.css?v=<?= time() ?>">
</head>
<body>
